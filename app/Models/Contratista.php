...
class Contratista extends Model
{
    ...
    {
        return $this->hasMany(Vehiculo::class, 'contratista_id');
    }

    public function embarcaciones(): HasMany
    {
        return $this->hasMany(Embarcacion::class, 'contratista_id');
    }

    // --- NUEVA RELACIÓN PARA MAQUINARIA ---
    public function maquinarias(): HasMany
    {
        return $this->hasMany(Maquinaria::class, 'contratista_id');
    }
    // --- FIN NUEVA RELACIÓN ---
}